...
# ---------------------------
#
# Will can use settings from the environment or this file, and sets
# reasonable defaults.
#
# Best practices: set keys and the like in the environment, and
# anything you'd be ok with other people knowing in this file.
#
# To specify in the environment, just prefix with WILL_
# (i.e. WILL_DEFAULT_ROOM becomes DEFAULT_ROOM).
#
# In case of conflict, you will see a warning message, and the value
# in this file will win.
...
# If will isn't accessible at localhost, you must set this for his
# keepalive to work.  Note no trailing slash.  PUBLIC_URL =
# "http://my-will.herokuapp.com"
...
ROOMS = ['DevOps', 'ODL engineering', '3.091r-exam', 'MITx Residential']
...
# Fully-qualified folders to look for templates in, beyond the two
# that are always included: core will's templates folder, and your
...
# User handles who are allowed to perform `admin_only` plugins.
